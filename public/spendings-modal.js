...
(function () {
  ...
  function injectCSS() {
    ...
    style.textContent = [
      ...
      '#sharedSpendingsModal .modal-close{border:none;background:#f1f5f9;color:#374151;font-size:1rem;width:36px;height:36px;border-radius:10px;cursor:pointer;transition:background .2s,color .2s;display:flex;align-items:center;justify-content:center;flex-shrink:0}',
      '#sharedSpendingsModal .modal-close:hover{background:#e2e8f0}',
      '.dark-theme #sharedSpendingsModal .modal-close{background:rgba(255,255,255,0.07)!important;border:1px solid rgba(255,255,255,0.12)!important;color:#94a3b8!important}',
      '.dark-theme #sharedSpendingsModal .modal-close:hover{background:rgba(255,255,255,0.13)!important;color:#e2e8f0!important}',
  ...
  function injectModal() {
    ...
    el.innerHTML = [
      ...
      '    <h2>Spendings</h2>',
      '    <button class="modal-close" id="sharedSpendingsClose" aria-label="Close"><i class="fa-solid fa-xmark"></i></button>',
      '  </div>',
      ...
      '      <div class="filter-group"><label>From <span class="date-badge">DATE</span></label><input type="date" id="ssFrom"></div>',
      '      <div class="filter-group"><label>To <span class="date-badge">DATE</span></label><input type="date" id="ssTo"></div>',
